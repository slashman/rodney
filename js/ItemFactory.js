...
ItemFactory.prototype.setThresholds = function (depth){
	...
	// Potion 2/6 = 200
	this.addPotionDefinition("HEALTH_POTION", "Medikit", 170);
	this.addPotionDefinition("EXTRA_HEALTH_POTION", "Large Medikit", 20 + tier3Bonus);
	this.addPotionDefinition("GAIN_STRENGTH_POTION", "Strength Serum", 5 + tier4Bonus);
	this.addPotionDefinition("GAIN_VITALITY_POTION", "Vitality Serum", 5 + tier4Bonus);
...
ItemFactory.prototype.getAnItem = function(){
	...
	return this.createItem("HEALTH_POTION");
};