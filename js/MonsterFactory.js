function MonsterFactory(){
	...
	this.levelMaps = {};
	this.addMonsterDefinition("GIANT_ANT", "Poisonous Mass", new Roll(2,4,0), 3,12, new Roll(1,6,1));
	this.addMonsterDefinition("BAT", "Bat", new Roll(1,8,1), 1, 8, new Roll(1,2,0));
	this.addMonsterDefinition("CENTAUR", "Beast", new Roll(4,8,0), 8, 17, new Roll(2,8,2));
