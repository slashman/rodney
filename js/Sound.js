function AudioAPI(){
	...
	this.addSound("SND_WALK",this.loadAudio("wav/walk.wav"));
	this.addSound("SND_SWORD",this.loadAudio("wav/sword.wav"));
	this.addSound("SND_LASER",this.loadAudio("wav/34.wav"));
}

AudioAPI.prototype.addSound = function(sndIndex, sound){
	this.sounds[sndIndex] = sound;
	this.sounds[sndIndex].sndIndex = sndIndex;
	this.sounds[sndIndex].copyPlay = this.playSound.bind(this, sound, false, false, 1);
};

AudioAPI.prototype.getSound = function(sndIndex){
