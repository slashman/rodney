function MonsterFactory(){
	...
	this.addMonsterDefinition("UMBER_HULK", "Umber Hulk", new Roll(8,8,0), 18, 50, new Roll(6,4,3));
	this.addMonsterDefinition("VAMPIRE", "Vampire", new Roll(8,8,0), 20, 50, new Roll(1,10,0));
	this.addMonsterDefinition("WRAITH", "Wraith", new Roll(5,8,0), 14, 23, new Roll(1,6,0));
